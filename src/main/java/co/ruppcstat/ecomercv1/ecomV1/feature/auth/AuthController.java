...
public class AuthController {
    ...
    @PatchMapping("/{email}/updateRoll")
    public void updateRoll(@Valid @PathVariable String email,@RequestBody UpdateRoleCreate updateRoleCreate) {
        authService.updateRoll(email, updateRoleCreate);
    }
